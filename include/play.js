    ...
    collector.on("collect", (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        case "⏹":
         ...
         case "🇪🇸":
         reaction.users.remove(user).catch(console.error);
        //   const userCheck = client.users.fetch();
        //   const bypepe = ("319068454432800768");
        //   const volkaer = ("323893214589222912");
        //   if (userCheck==bypepe) return i18n.__("common.chillUser");
        //   if (userCheck==volkaer) return i18n.__("common.chillUser")
        //     queue.textChannel
        //       .send(
        //        ("Viva Españia! 🇪🇸")
        //   )
